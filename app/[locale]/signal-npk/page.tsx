...
const content = {
  ...
  ar: {
    ...
    matrix: {
      ...
      intro: "تشترك كل تركيبات سيجنال في نفس مجموعة العناصر الصغرى المخلبية والمحفّز العضوي النشط — يتغيّر توازن العناصر الكبرى فقط. اختر بين المنتجات لعرض التركيب الكامل.",
      labels: {
    ...
    mech: {
      ...
      steps: [
        {
          no: "01",
          title: "الامتصاص عن طريق ثغور الاوراق",
        ...
        {
          no: "02",
          title: "الانتقال في اللحاء",
          text: "تعمل السكريات الأحادية والعناصر العضوية كوسائط نقل، فتنتقل العناصر مباشرة في الخلايا الغربالية باللحاء فور دخولها الورقة."
        },
        {
          no: "03",
          title: "الانتشار في الاتجاهين",
          text: "تتحرك العناصر صعودًا وهبوطًا معًا — لتغذي الأفرع والثمار والجذور من رشة واحدة، باستجابة ملحوظة خلال ساعات."
        }
      ],
      figureLabel: "سيجنال - الامتصاص عبر ثغور الاوراق"
    },
    usage: {
...
export default async function SignalNpkPage({ params }: PageProps) {
  ...
  return (
    <div
      dir={t.dir}
      className={`${cairo.className} own-ground native-width-page relative min-h-screen overflow-x-clip bg-[#F4F8F5] text-[#17142D] antialiased`}
    >
