  ...
  return (
    <section className={`${className} py-12 sm:py-14 lg:py-[100px]`}>
      <RevealSection className="container-shell" amount={0.15}>
        <div className="relative overflow-hidden rounded-md border border-agri-line bg-white p-6 shadow-soft sm:p-8 lg:p-10">
          ...
          <div className="relative grid gap-6">
            ...
            {cta ? (
              <Link href={localizeHref(locale, cta.href)} className="btn-secondary w-full sm:w-fit">
                {cta.label}
              </Link>
            ) : null}
          </div>
